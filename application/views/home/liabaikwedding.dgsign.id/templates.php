...
<head>
  ...
  <base href="<?=base_url('public/wi_template/liabaikwedding.dgsign.id/')?>"/>
...
<body>
    ...
    <div class="landing-page h-screen pt-20 lg:pt-40 flex items-center flex-col relative" style="transition: all 0.4s ease-in-out;">
        <img src="foto1.png" class="absolute md:w-full md:h-screen lg:hidden top-0 object-cover" style="filter:brightness(80%);z-index:-1;" alt="">
        <img src="1.jpeg" class="absolute h-screen md:w-full hidden lg:block md:hidden top-0 object-cover" style="filter:brightness(80%);z-index:-1;" alt="">
        <div class="text-center tracking-widest" style="color: #fafafa;">
            <h5 class="text-base lg:text-xl SEGOEUI">The Wedding of</h5>
            <h3 class="mt-10 text-5xl lg:text-6xl Bestermind">Lia & Baik</h3>
        </div>
        <div class="mt-12 text-center tracking-widest">
            <h5 class="text-base lg:text-xl futura-md" style="color:#fafafa">02 | 10 | 21</h5>
            <h5 class="text-base lg:text-xl futura-md" style="color:#fafafa"> </h5>
            <h5 class="text-base lg:text-xl futura-md" style="color:#fafafa"> </h5>
        </div>
        <div class="mt-12 text-center" style="z-index:2;">
              <h5 class="text-base lg:text-xl futura-md" style="color:#fafafa"> </h5>
			  <h5 class="text-base lg:text-xl futura-md" style="color:#fafafa"> </h5><br><br>
<?php
    ...
    <div class="mainContent content bg-white" style="display: none;">
        ...
        <div class="h-screen pt-44 lg:pt-72 flex items-center flex-col relative" style="z-index: 2;">
            <img src="foto2.png" class="absolute md:w-full md:h-screen lg:hidden top-0 object-cover" style="filter:brightness(80%);z-index:-1;" alt="">
            <img src="2.jpeg" class="absolute h-screen md:w-full hidden lg:block md:hidden top-0 object-cover" style="filter:brightness(80%);z-index:-1;" alt="">
            <div class="text-center" style="color: #fafafa;z-index:2;">
                <h5 class="text-lg lg:text-xl futura-md"> </h5><br><br><br><br>
                <h3 class="text-5xl lg:text-6xl pt-12 lg:pt-8 Bestermind">Lia & Baik</h3>
            </div>
        ...
        <div class="flex justify-between items-center flex-col relative" style="background: #fcf8f0;z-index: 2;">
            ...
            <div class="text-center ovale py-16 px-2 w-full flex flex-col items-center js-scroll fade-in-bottom" style="z-index: 1;">
                <h3 class="text-2xl DancingScript" style="color:#7B4F06"> </h3>
                <h3 class="p-4 text-lg futura-md" style="color:#7B4F06">Bismillahirramanirrahim</h3>
                <p class="text-sm lg:text-base futura-md md:w-9/12" style="color:#7B4F06">"Dan diantara tanda-tanda kekuasaan-Nya ialah Dia menciptakan untukmu isteri-isteri dari jenismu sendiri, supaya kamu merasa tenang dan tentram kepadanya, dan dijadikan-Nya diantaramu rasa kasih dan sayang. Sesungguhnya pada yang demikian itu benar-benar terdapat tanda-tanda bagi kaum yang berfikir." (QS:. Ar-Rum: 21)</p>
            </div>
            <div class="w-full -mt-20">
                <img src="foto3.png" class="relative halfcirc-img lg:hidden object-cover" style="" alt="">
                <img src="3.jpeg" class="relative halfcirc-img hidden md:hidden lg:block object-cover" style="" alt="">
            </div>
        </div>
        <div class="mt-12 md:mt-22">
            <div class="py-12 text-center flex justify-center relative">
                ...
                <p class="w-9/12 lg:w-3/6 lg:text-xl js-scroll fade-in-bottom">
                    Dengan memohon ridho dan rahmat Allah Subhanahuwataala izinkan kami mengundang Bapak/Ibu/Saudara/i untuk menghadiri dan memberikan doa restu pada pernikahan kami :
                </p>
            ...
            <div class="mt-8 lg:flex lg:justify-evenly lg:items-baseline relative">
                ...
                <div class="pt-14 lg:w-5/12 flex items-center flex-col js-scroll fade-in-bottom text-center">
                    <img src="P1.png" class="rounded-full w-80 h-80 mb-6" alt="">
                    <h5 class="text-sm lg:text-xl tracking-widest SEGOEUI">Febriliana Ramadhanti Widari S.S</h5>
                    <h1 class="my-4 text-5xl cl-dark-cream tracking-widest Bestermind">Lia</h1>
                    <h5 class="mb-2 text-sm lg:text-xl SEGOEUI">Anak Tunggal dari Keluarga </h5>
                    <div class="w-7/12 lg:w-9/12 text-center text-sm lg:text-xl SEGOEUI">
                        <h5>Bapak Sri Widodo</h5>
                        <h5>&</h5>
                        <h5>Ibu Puji Lestari</h5>
                    </div>
                    
                </div>
                <div class="mt-6 lg:w-5/12 flex items-center flex-col js-scroll fade-in-bottom text-center">
                    <img src="P2.png" class="rounded-full w-80 h-80 mb-6" alt="">
                    <h5 class="text-sm lg:text-xl tracking-widest SEGOEUI">Baik Catur Ardiansyah S.Kom</h5>
                    <h1 class="my-4 text-5xl cl-dark-cream tracking-widest Bestermind">Baik</h1>
                    <h5 class="mb-2 text-sm lg:text-xl SEGOEUI">Anak Keempat dari Keluarga</h5>
                    <div class="w-7/12 lg:w-9/12 text-center text-sm lg:text-xl SEGOEUI">
                        <h5>Bapak Sundari (alm)</h5>
                        <h5>&</h5>
                        <h5>Ibu Mujiharti</h5>
                    </div>
                ...
                <div class="flex items-center flex-col">
                    <div class="w-9/12 text-center">
                        ...
                        <div class="pt-16 cl-dark-cream font-bold flex items-center flex-col js-scroll fade-in-bottom">
                            ...
                            <h5 class="pt-6 SEGOEUI">Sabtu, 02 Oktober 2021</h5>
                            <h5 class="SEGOEUI">Pukul : 15.00 WIB</h5>
                            <h5 class="SEGOEUI">Rumah KS 15</h5>
							<h5 class="SEGOEUI">Jl. Kyai Saleh No.15 Semarang</h5>
                            <a href="https://maps.app.goo.gl/CFqPDADF7AHcprAu5" target="_blank" class="rounded-full py-2 px-8 mt-8 flex justify-between items-center" style="background-color: #7B4F06;">
                        ...
                        <div class="pt-16 cl-dark-cream font-bold flex items-center flex-col js-scroll fade-in-bottom">
                            <img src="wedding-ring.svg" class="rounded-full h-24 w-24 p-4 mb-4" alt="ring icon" style="background-color: #C6B08B;">
                            <h1 class="text-3xl cl-dark-cream Bestermind">Resepsi</h1>
                            <div class="h-0.5 w-48 mt-2" style="background-color: rgba(199, 206, 190, .35);"></div>
                            <h5 class="pt-6 SEGOEUI">Sabtu, 02 Oktober 2021</h5>
                            <h5 class="SEGOEUI">Pukul: <?php
                                if(isset($undangan->ivts_Name)){
                                    ?>
									<?=$undangan->ivts_Group?>
								<?php
            ...
            <div class="mt-16 flex items-center flex-col">
                <div class="text-center js-scroll flex flex-col items-center fade-in-bottom">
                    <p class="mb-16 w-9/12 cl-dark-cream lg:text-xl SEGOEUI">
                        Prosesi Akad hanya dihadiri keluarga dan kerabat terdekat. <br><br> Suatu kehormatan bagi kami, apabila Bpk/Ibu/Sdra/i dapat menghadiri Resepsi Pernikahan dan turut memberikan doa di hari bahagia kami.
                    </p>
                   
                </div>
            </div>
            <div class="my-16 flex items-center flex-col relative" style="z-index: 2;">
                <img src="foto5.png" class="halfcirc-img absolute clip-ellipse top-0 lg:hidden object-cover" style="z-index: -1;" alt="">
                <img src="5.png" class="halfcirc-img absolute clip-ellipse top-0 hidden md:hidden lg:block object-cover" style="z-index: -1;" alt="">
            ...
            <div class="ovale--long py-16 -mt-4 mb-16 cl-dark-cream futura-md relative" style="">
                ...
                <div class="flex items-center flex-col js-scroll fade-in-bottom">
                    <h1 class="pt-20 text-5xl cl-dark-cream tracking-widest Bestermind">RSVP</h1>
                    <p class="py-4 px-4 md:w-8/12 text-center">Sehubungan dengan adanya pandemi Covid-19, konfirmasi kehadiran acara dengan cara mengisi data dibawah ini sebelum:</p>
                    <h3 class="text-lg font-bold">Pukul 21.00 - 29 September 2021</h3>
            ...
            <div class="w-full mt-16 mb-0">
                <div class="iframe--cont flex justify-center items-center">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/3kbYGxuPl3A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="relative">
            ...
            <div class="my-16 flex flex-col justify-center items-center">
                ...
                <div class="w-9/12 md:w-6/12 lg:w-4/12 js-scroll fade-in-bottom">
                    <div class="my-3 flex justify-center items-start md:justify-start md:items-start SEGOEUI font-bold">
                        <h3 class="rounded-full w-6 h-6 px-2 pt-px mr-4 text-left text-sm" style="background-color: #7B4F06;color: #F9F3E7;">1</h3>
                        <h3 class="text-base font-normal">Wajib menggunakan masker dan dilakukan pengecekan suhu.</h3>
                    </div>
                    <div class="my-3 flex justify-center items-start md:justify-start md:items-start SEGOEUI font-bold">
                        <h3 class="rounded-full w-6 h-6 px-2 pt-px mr-4 text-left text-sm" style="background-color: #7B4F06;color: #F9F3E7;">2</h3>
                        <h3 class="text-base font-normal">Menunjukan QR Code yang diberikan sebagai pengganti buku tamu.</h3>
                    </div>
                    <div class="my-3 flex justify-center items-start md:justify-start md:items-start SEGOEUI font-bold">
                        <h3 class="rounded-full w-6 h-6 px-2 pt-px mr-4 text-left text-sm" style="background-color: #7B4F06;color: #F9F3E7;">3</h3>
            ...
            <div class="mt-16 mb-8 relative" style="height: 428px;">
                <img src="foto4.png" class="absolute halfcirc-img top-0 lg:hidden object-cover" style="" alt="">
                <img src="4.png" class="absolute halfcirc-img top-0 hidden md:hidden lg:block object-cover" style="" alt="">
                <div class="pt-44 flex justify-center items-center flex-col js-scroll fade-in-bottom">
                    <h5 class="SEGOEUI lg:text-xl font-bold" style="color:#fafafa;">Thank You</h5>
                    <h1 class="text-3xl lg:text-5xl mt-2 lg:mt-6 Bestermind" style="color:#fafafa;">Lia & Baik</h1>
                </div>
            </div>
            <div class="pb-8 mx-auto text-center relative">
                ...
                <span class="text-xs font-bold SEGOEUI">it's you sezairi</span>
            </div>
...
<script>
    ...
    <script>
        ...
        var countDownDate = new Date("Oct 2, 2021 18:00:00").getTime();
