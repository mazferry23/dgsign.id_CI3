...
<head>
    ...
    <base href="<?=base_url('public/dgsign2020-iceblue/')?>"/>
    <!-- Site fevicon icons -->
...
<body>
        ...
        <section class="intro" style="background-image: url('<?=site_url('public/uploads/'.$cover)?>');">
            <div class="cage-section">
                ...
                if(!empty($undangan) && isset($undangan->ivts_Name)){
                    ...
                    <div class="qrcode">
                        <a data-lightbox="example-1" data-title="<?=$undangan->ivts_Name?>" href="<?=site_url('home/createqr/'.$undangan->ivts_Uuid)?>"><img src="<?=site_url('home/createqrrsvp/'.$undangan->ivts_Uuid)?>"/></a>
                    </div>
                    <?php
                }
                ?>
	...
	<!-- Modal -->
    <!-- <div class="modal fade" id="audioModal" role="dialog" backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                This website want to play an Audio, do you want allow it?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Deny</button>
                <button type="button" id="allow-an-audio" class="btn btn-primary">Allow</button>
            </div>
            </div>
        </div>
    </div> -->
    ...
    //typeof $('audio')[0] !=='undefined' ? $('#audioModal').modal({backdrop:'static',show:true}) : '';
    // $('#allow-an-audio').click(function(){
