                    ...
                    if (g._shouldScan) {
                        if (g._localMediaStream) {
                            var c = g._videoElement,
                                ...
                                k = g._qrRegion.x * d,
                                l = g._qrRegion.y * e;
                            g._context.drawImage(g._videoElement, k, l, i, j, 0, 0, g._qrRegion.width, g._qrRegion.height), n() || !0 === h.disableFlip || (f._context.translate(f._context.canvas.width, 0), f._context.scale(-1, 1), n())
                        }
