...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url('public/scanner/')?>assets/css/qr/style.css">
...
//    }else{
 ...
 //   }
    ...
    <main>
            ...
            <section class="scan">
                <div class="container">
                    ...
                    <div class="box-container">
                            ...
                            <source src="<?=base_url('public/scanner/')?>assets/audio/beep.mp3" type="audio/mpeg">
                            </audio>
                            <?php 
                                // $username = $_SESSION['username'];
                                // $id_event = $_SESSION['id_event'];
        ...
        <section class="search ">
            <div class="container ">
                ...
                <form class="exampl" action="<?=site_url('scanner/home/invit')?>" id="formsv" method="post" hidden>
                ...
                <div class="btn-container ">
                    ...
                    <button class="btn btn-sm btn-scan "><a href="<?=site_url('scanner/home/invit')?> "><i class="far fa-edit "></i> Input Manual</a></button>
    ...
    <script src="<?=base_url('public/scanner/')?>assets/js/qr/html5-qrcode.min.js"></script>
    <script>
