...
<div class="row">
    <div class="col-md-12">
        <div class="pull-right">
			...
			<a href="javascript:;" id="button-plus-ivt" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> Export Data</a>
            ...
            <table id="table-list-invitation" class="display table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Perkiraan Souvenir</th>
                        <th>Souvenir Diberikan</th> 
                        <th>Waktu Souvenir</th>
                        <th>Nama Pemberi Souvenir</th>
                        <th>Foto Selfie</th>
