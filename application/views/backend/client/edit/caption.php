                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <span class="text-helper">Variabel {{NAME}} untuk nama undangan, {{ADDR}} untuk alamat, {{LINK}} untuk link undangan, {{TAMU}} untuk jumlah tamu prediksi, {{EXTLINK}} untuk link undangan External, {{TIME}} untuk Dynamic Waktu</span>
                                </div>
                            </div>
