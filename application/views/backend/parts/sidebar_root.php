<!-- sidebar menu start-->
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a <?=$this->uri->segment(2)=='template' ? 'class="active"' : ''?> href="javascript:;">
                          <i class="fa fa-sitemap"></i>
                          <span>Template</span>
                      </a>
                      <ul class="sub">
                          <li <?=$this->uri->segment(2)=='template' && $this->uri->segment(3)=='' ? 'class="active"' : ''?>><a  href="<?=site_url('backend/template')?>">List Template</a></li>
                          <li <?=$this->uri->segment(2)=='template' && $this->uri->segment(3)=='create' ? 'class="active"' : ''?>><a  href="<?=site_url('backend/template/create')?>">Upload Template</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li <?=$this->uri->segment(2)=='prokes' && $this->uri->segment(3)=='create' ? 'class="active"' : ''?>><a  href="<?=site_url('backend/prokes/create')?>">Create Client</a></li>
                      </ul>
                  </li>
                  <!--
